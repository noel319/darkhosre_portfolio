    ...
    >
      <div>
        <div className="flex items-center justify-between">
          <h4 className="relative z-10 block font-semibold md:font-bold transition-colors duration-500 group-hover:text-neutral-50 text-[25px] tracking-tighter">
            {heading}
          </h4>
        ...
        <p className="relative z-10 mt-2 block text-foreground/50 transition-colors duration-500 group-hover:text-neutral-50 pt-2 text-[25px]">
          {subheading}
        </p>
      </div>
